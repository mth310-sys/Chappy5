...
- 2024-09-17 1機種 COMPLETE_CORE: P攻殻機動隊SAC_2045 199LTver.。
- 次回再開地点: **2024-09-17同日候補の取りこぼし最終確認後、2024年10月の次の導入日へ時系列前進。** 詳細は `LATEST_HANDOFF.md`。
...
| 2024-09-17 | P攻殻機動隊SAC_2045 199LTver. | D-light（大一商会系） | COMPLETE_CORE |
...
- 2024-09-02同日候補は新台カレンダーを再確認。Pとある科学の超電磁砲2、P DD北斗の拳3等に当該スペックのLT搭載根拠を確認できず、DBへ混入させない。
- 2024-09-17 P攻殻機動隊SAC_2045 199LTver. — 1/199.8、RUSH65.5%（丸め約66%）、GHOST RUSH約51%、LT「GHOST RUSH BURST」約86%。通常0.5%直行またはGHOST RUSH中3000個/初当り含む3連でLT。解析直接値LT初当り1/1162.27（初当り約5.8回に1回）。2025大入りLTver./後発LT99ver.と分離。
...
- 2024-09-17 P攻殻機動隊は業界記事、P-WORLD/HAZUSE、必勝本、パチマガスロマガを横断。65.5%/約66%は丸め差として整理し、LT総到達直接値と0.5%直行率を分離。
- 通常初当り基準の総LT到達率が直接公表されない機種は経路別数値のみ保存し、合算推測しない。

## Latest relay note — Relay 1
retrievedAt: 2026-09-21
- 最新main README、LTミッションv0.1、INDEX、LATEST_HANDOFF、既存機種レコードを確認。
- 2024-09-02同日候補の境界を再確認し、既登録3機種以外を無根拠にLT登録しないことを確認。
- 2024-09-17 `P攻殻機動隊SAC_2045 199LTver.` をCOMPLETE_CORE登録。
- 詳細な引継ぎは `LATEST_HANDOFF.md` に保存。

### 次回再開地点
**2024-09-17同日全パチンコ候補の取りこぼしを最終確認し、その後2024年10月の最初の導入日へ進む。P攻殻機動隊199LTは具体的なQA問題がない限り再収集しない。**
