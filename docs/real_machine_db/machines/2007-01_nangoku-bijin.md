...
resetBehavior:
  settingChangeBehavior: UNVERIFIED（機種名/南国美人&30/設定変更/リセット/朝一/CZ/RT引継ぎ等で再探索したが高信頼資料を確認できず）
...
- url: https://cs62.cs-plaza.com/g/pachi/pla/s_conq/olympia_slot/77/a.php
  acquired: 2026-08-31
  confidence: ANALYSIS_HIGH
  note: パチマガスロマガ。5号機、BIG/REG獲得性能、RT最大100P・約0.4枚/G。
...
- url: https://www.p-world.co.jp/machine/database/4515
  acquired: 2026-08-31
  confidence: INDUSTRY
  note: P-WORLD機種DB。設定別BIG/REG確率を照合。
- url: https://dorubako.biz/year/2007.html
  acquired: 2026-08-31
  confidence: ANALYSIS_SINGLE
  note: 2007年1月導入一覧の月境界確認。
missingFields:
