...
releaseDateStatus: **CONFLICT_OR_MARKET_DATE_DEFINITION_DIFFERENCE**。K-Naviの2011年10月導入カレンダーは2011-10-10を「全国一斉導入開始日」として掲載。パイオニア公式は2011年10月発売、2011-08-18のグリーンべると業界記事は「納品は10月2日からを予定」と記載し、K-Naviには2011-10-05付の実戦レビューも存在する。納品開始・地域先行導入・全国一斉導入の定義差として平均せず保持し、本DBのchronology keyは全国一斉導入開始日の2011-10-10を採用する。
generation: 5号機
...
- K-Navi 2011年10月導入カレンダーで本機を2011-10-10全国一斉導入開始として確認。
- グリーンべるとは2011-10-02納品開始予定、K-Navi実戦レビューは2011-10-05付。市場投入定義差としてCONFLICT保持し、chronology keyはK-Naviの全国一斉導入開始日を採用。
...
1. **導入日/市場投入日定義**
   - K-Navi導入カレンダー: 2011-10-10全国一斉導入開始日。
   - パイオニア公式: 2011年10月発売。
   - グリーンべると: 2011-10-02納品開始予定。
   - K-Navi実戦レビュー: 2011-10-05付。
   - chronology keyは全国一斉導入開始日2011-10-10を採用し、他値は削除/平均しない。
2. **ボーナス確率の丸め**
...
7. K-Navi — キングハナハナ-30レビュー（赤牌さん）
   - https://p-kn.com/slot/1480/review/31255/
   - 2011-10-05投稿。10月初旬の地域先行稼働を補強。
