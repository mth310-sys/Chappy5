...
machineName: 日本一の桃太郎CT5
manufacturer: ベルコ
releaseDate: 2005-10
generation: 5号機初期
systemType: ボーナス主体 / 2種BB（CT）搭載 / RTなし
...
別資料「5号機クロニクル」では 94.5 / 96.6 / 99.3 / 101.0 / 102.8 / 104.2% と掲載されており、丸めだけでは説明しにくい差があるためCONFLICTとして保持する。
...
- BIG: 規定払い出し360枚超で終了 / 純増約312枚
- CB: 規定払い出し255枚超で終了 / 純増約221枚

信頼度: ANALYSIS_HIGH

## modeSpecificMinimumData

- 5号機初期の2種BB（当時「CT」と呼ばれた方式）搭載機
- RTなし
