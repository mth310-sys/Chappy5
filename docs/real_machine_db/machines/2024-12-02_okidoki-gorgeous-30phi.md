...
recordNo: 1692
machineName: 沖ドキ！ゴージャス 30φ
aliases: 沖ドキ！ゴージャス-30 / S沖ドキ！ゴージャス30Φ / S／沖ドキ！BLACK／XA
manufacturer: エレコ
formalModel: S／沖ドキ！BLACK／XA
inspectionCode: 4S0556
releaseDate: 2024-12-02
generation: 6.6号機 / メダル機 / 30φ
systemType: AT / 完全告知・擬似ボーナス
settings: 1 / 2 / 3 / 5 / 6 / L
coreStatus: COMPLETE_CORE

## releaseAndModelEvidence
- 遊技通信はエレコ製型式 `S／沖ドキ！BLACK／XA` として発表。
- P-WORLD、パチビー等で2024-12-02導入、30φ版を確認。
- 検定番号4S0556は型式別機種DBで照合。
...
- 有利区間は6,000G対応。
- モードは通常A/B、引き戻し、チャンス、天国、ドキドキ、超ドキドキ、保証、赤ドキ、裏ドキ。
...
### carryOverBehavior
- 設定変更を伴わない据え置き時のモード・天井進行について、朝一リセット恩恵は発生しない。
...
### stateAfterReset
- 本機は名称付きモード管理が主要朝一契約。独立した高確/低確状態の朝一振り分けは物差し必須値として固定公開値を確認できず `PUBLIC_VALUE_NOT_FOUND_AFTER_RESEARCH`。
...
- ANALYSIS_HIGH: https://www.p-world.co.jp/machine/database/10137
- ANALYSIS_HIGH: https://www.pachibee.jp/machines/about/224100008
- ANALYSIS_HIGH: https://www.pachibee.jp/machines/kouryaku/224100008
...
- ANALYSIS_SINGLE_MODEL_ID: https://ativo.jp/2024/10/08/%EF%BD%93%E6%B2%96%E3%83%89%E3%82%AD%E3%82%B4%E3%83%BC%E3%82%B8%E3%83%A3%E3%82%B9-30%CF%86/
