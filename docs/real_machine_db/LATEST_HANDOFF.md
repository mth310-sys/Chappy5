...
- 同時QAで321 `いみそ～れ2ピュアエディション30` の正式型式を **`イミソーレ2N-30`** と新規根拠から確定し、レコードへ反映済み。
...
- `いみそ～れ2ピュアエディション30` の正式型式を **`イミソーレ2N-30`** へ修正済み。
- 根拠1: 2008-11-17東京都公安委員会告示第396号の検定記録にエマ `イミソーレ2N-30`。
- 根拠2: 機器対応表が `イミソーレ2ピュアエディション30（イミソーレ2N-30）` と対応付け。
- 25φの `イミソーレ2H` とは別型式として保持。
- source: https://p-mans.blogspot.com/2008/11/ / https://happylibus.com/doc/672417/灰皿フタ機種対応表
