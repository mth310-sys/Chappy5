...
- 2026-09-15時点で「2026年9月 パチスロ 新台 9月15日 導入」「9月14日 パチスロ 新台 導入」「9月15日 スマスロ 新台 導入」等へ検索語を変更し、パチナビ、パチマガスロマガ、ちょんぼりすた、P-Summa、店舗導入観測、業界ニュースを横断して現行差分を再監査。
- パチナビは2026年9月のパチスロを9/7の6機のみ掲載。パチマガスロマガも9/7の同6機のみで、次のパチスロ全国導入日は10/5。ちょんぼりすたも9/7の同6機で一致。P-Summaも「9月のパチスロ新台はすべて7日導入開始予定、全6機種」と整理。
- 9/14の店舗導入観測はパチンコ機中心。9/10等に観測されるスロットは既存機の店舗単位後発導入で、全国初回導入の新規型式根拠ではない。
- 9/9〜9/11の業界ニュースではライザのアトリエ、モンスターハンターライズ：サンブレイク、Lウミンチュ等の発売発表を確認したが、いずれも現行日9/15までの全国初回導入を示すものではないため先行登録しない。
...
- パチマガスロマガ 新台導入カレンダー: https://psmaga.com/new_machine/index.php
- ちょんぼりすた 新台カレンダー: https://chonborista.com/shindai/4197/
