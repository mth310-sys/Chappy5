...
function addChain(o,len,h,resWin,switchWin,delta){const k=String(len);if(!o.chain[k])o.chain[k]={samples:0,resWins:{2:0,3:0},switchWins:{2:0,3:0},delta:{2:0,3:0}};const c=o.chain[k];c.samples++;if(resWin)c.resWins[h]++;if(switchWin)c.switchWins[h]++;c.delta[h]+=delta}
